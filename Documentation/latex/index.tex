...
{\bfseries{\href{https://github.com/jamesbrindle/YTMusicUploader/releases/tag/v1.3.1}{\texttt{ Download Version 1.\+3 Installer}}}} ~ ~\hypertarget{index_autotoc_md1}{}\doxysubsection{Application}\label{index_autotoc_md1}
...
~ $\ast$$\ast$ $\ast$ This application does not send any telemetry data of any kind to its source.$\ast$$\ast$ $\ast$$\ast$ $\ast$ Valid file formats are the same as You\+Tube Music\+: .flac, .m4a, .mp3, .oga, .wma$\ast$$\ast$ ~ ~\hypertarget{index_autotoc_md3}{}\doxysubsection{Reason for Creation}\label{index_autotoc_md3}
...
\item \href{https://github.com/avatar29A/MusicBrainz}{\texttt{ Music\+Brainz A\+PI}} ~ ~
...
I\textquotesingle{}m going to be using this application for personal use, so I\textquotesingle{}ll know straight aware when it\textquotesingle{}s not working and will attempt to update the A\+PI call implementation as soon as possible. ~ ~\hypertarget{index_autotoc_md11}{}\doxysubsection{Further Development Considerations}\label{index_autotoc_md11}

\begin{DoxyItemize}
\item Could do with the ability to see if a music file is already uploaded to You\+Tube Music or not. I could not find a way of requesting a file hash from You\+Tube Music. I could only get a json object back with a typical free text search of the song title and artist and found it not reliable enough, with multiple \textquotesingle{}fuzzy / AI logic\textquotesingle{} result sets for \textquotesingle{}similar\textquotesingle{} songs. I\textquotesingle{}ll keep working on it.
...
\end{DoxyItemize}\hypertarget{index_autotoc_md12}{}\doxysubsection{Special Thanks}\label{index_autotoc_md12}
