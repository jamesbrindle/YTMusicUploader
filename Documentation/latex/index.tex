...
Automatically upload your local personal music library to You\+Tube Music. ~ ~

{\bfseries{\href{https://github.com/jamesbrindle/YTMusicUploader/releases/tag/v1.3.4}{\texttt{ Download Version 1.\+3.\+4 Installer}}}} ~ ~\hypertarget{index_autotoc_md1}{}\doxysubsection{Application}\label{index_autotoc_md1}
...
~
\begin{DoxyItemize}
\item {\bfseries{This application does not send any telemetry data of any kind to its source.}}
\item {\bfseries{Valid file formats are the same as You\+Tube Music\+: .flac, .m4a, .mp3, .oga, .wma}} ~
\end{DoxyItemize}
...
\item \href{https://www.nuget.org/packages/TagLibSharp/}{\texttt{ Tag\+Lib\+Sharp -\/ Read music gile tags}} ~ ~
