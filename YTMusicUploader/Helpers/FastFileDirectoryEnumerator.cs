...
namespace JBToolkit.Windows
{
    ...
    public static class FastDirectoryEnumerator
    {
        ...
        /// 
        /// Usage Example:
        /// foreach (FileData f in FastDirectoryEnumerator.EnumerateFiles(path, searchPattern))
        /// { }
        /// 
        /// </summary>
        /// <param name="path">The path to search.</param>
        ...
        /// 
        /// Usage Example:
        /// foreach (FileData f in FastDirectoryEnumerator.EnumerateFiles(path, searchPattern, searchOption))
        /// { }
        /// 
        /// </summary>
        /// <param name="path">The path to search.</param>
