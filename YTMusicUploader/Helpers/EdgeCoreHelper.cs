...
namespace YTMusicUploader.Helpers
{
    ...
    public class EdgeCoreHelper
    {
        ...
        {
            var edgeCoreFilesList = new EdgeCoreHelper().EdgeFilesList.ToList();
        ...
        private EdgeCoreFile[] EdgeFilesList { get; } = {
            new EdgeCoreFile{ Path = Path.Combine(Global.EdgeFolder, @"84.0.522.63.manifest"), Size = 222},
