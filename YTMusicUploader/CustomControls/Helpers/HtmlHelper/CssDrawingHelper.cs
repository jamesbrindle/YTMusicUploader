...
namespace System.Drawing.Html
{
    ...
    internal static class CssDrawingHelper
    {
        ...
        /// <param name="p"></param>
        /// <returns></returns>
        private static PointF RoundP(PointF p)
        {
            return p;
        }
        ...
        /// <param name="forceNonRound"></param>
        ...
        public static GraphicsPath GetBorderPath(Border border, CssBox b, RectangleF r, bool isLineStart,
            bool isLineEnd, bool forceNonRound = false)
        {
            ...
            switch (border)
            {
                case Border.Top:
                    ...
                    pts[0] = RoundP(new PointF(r.Left + (forceNonRound ? 0 : b.ActualCornerNW), r.Top));
                    pts[1] = RoundP(new PointF(r.Right - (forceNonRound ? 0 : b.ActualCornerNE), r.Top));
                    pts[2] = RoundP(new PointF(r.Right - (forceNonRound ? 0 : b.ActualCornerNE), r.Top + bwidth));
                    pts[3] = RoundP(new PointF(r.Left + (forceNonRound ? 0 : b.ActualCornerNW), r.Top + bwidth));

                    if (isLineEnd && (b.ActualCornerNE == 0f || forceNonRound))
                    {
                        pts[2].X -= b.ActualBorderRightWidth;
                    }

                    if (isLineStart && (b.ActualCornerNW == 0f || forceNonRound))
                    {
                        pts[3].X += b.ActualBorderLeftWidth;
                    }

                    if (b.ActualCornerNW > 0f && !forceNonRound)
                    {
                ...
                case Border.Right:
                    ...
                    pts[0] = RoundP(new PointF(r.Right - bwidth, r.Top + (forceNonRound ? 0 : b.ActualCornerNE)));
                    pts[1] = RoundP(new PointF(r.Right, r.Top + (forceNonRound ? 0 : b.ActualCornerNE)));
                    pts[2] = RoundP(new PointF(r.Right, r.Bottom - (forceNonRound ? 0 : b.ActualCornerSE)));
                    pts[3] = RoundP(new PointF(r.Right - bwidth, r.Bottom - (forceNonRound ? 0 : b.ActualCornerSE)));


                    if (b.ActualCornerNE == 0f || forceNonRound)
                    {
                        pts[0].Y += b.ActualBorderTopWidth;
                    }

                    if (b.ActualCornerSE == 0f || forceNonRound)
                    {
                ...
                case Border.Bottom:
                    ...
                    pts[0] = RoundP(new PointF(r.Left + (forceNonRound ? 0 : b.ActualCornerSW), r.Bottom - bwidth));
                    pts[1] = RoundP(new PointF(r.Right - (forceNonRound ? 0 : b.ActualCornerSE), r.Bottom - bwidth));
                    pts[2] = RoundP(new PointF(r.Right - (forceNonRound ? 0 : b.ActualCornerSE), r.Bottom));
                    pts[3] = RoundP(new PointF(r.Left + (forceNonRound ? 0 : b.ActualCornerSW), r.Bottom));

                    if (isLineStart && (b.ActualCornerSW == 0f || forceNonRound))
                    {
                        pts[0].X += b.ActualBorderLeftWidth;
                    }

                    if (isLineEnd && (b.ActualCornerSE == 0f || forceNonRound))
                    {
                ...
                case Border.Left:
                    ...
                    pts[0] = RoundP(new PointF(r.Left, r.Top + (forceNonRound ? 0 : b.ActualCornerNW)));
                    pts[1] = RoundP(new PointF(r.Left + bwidth, r.Top + (forceNonRound ? 0 : b.ActualCornerNW)));
                    pts[2] = RoundP(new PointF(r.Left + bwidth, r.Bottom - (forceNonRound ? 0 : b.ActualCornerSW)));
                    pts[3] = RoundP(new PointF(r.Left, r.Bottom - (forceNonRound ? 0 : b.ActualCornerSW)));
                    ...
                    if (b.ActualCornerSW == 0f || forceNonRound)
                    {
