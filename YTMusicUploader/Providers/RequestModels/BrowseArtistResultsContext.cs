namespace YTMusicUploader.Providers.RequestModels
{
    ...
    /// </summary>
    public class BrowseArtistResultsContext : IRequestModel
    {
        ...
        {
            public Musiciconbadgerenderer musicIconBadgeRenderer { get; set; }
            public Musicthumbnailrenderer musicThumbnailRenderer { get; set; }
        }

        public class Musiciconbadgerenderer
        {
            public string trackingParams { get; set; }
        ...
        public class Header
        {
            public Musicheaderrenderer musicHeaderRenderer { get; set; }
        }

        public class Musicheaderrenderer
        {
