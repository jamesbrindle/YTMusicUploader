...
{
    /// <summary>
    /// Deserialised HttpWebRequest request body sent for adding a playlist item
    /// </summary>
    public class AddPlaylistItemContext
    {
        ...
        public class Context
        {
            ...
            public Activeplayer[] activePlayers { get; set; }
        ...
        {
            public string playerContextParams { get; set; }
        }
        ...
        public class Action
        {
            ...
            public string dedupeOption { get; set; }
        }
    }
}